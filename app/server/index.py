...
def move_mouse(finger_coords):
    if mc.is_tracking_on():
        mouse_origin = mc.get_mouse_origin()
        finger_origin = mc.get_finger_origin()
        finger_bounds = mc.get_finger_bounds()
        finger_x_in_bounds = finger_coords[0] - finger_origin[0] > 0 and finger_coords[0] - finger_bounds[0]
        finger_y_in_bounds = finger_coords[1] - finger_origin[1] > 0 and finger_coords[1] - finger_bounds[1]
        if finger_x_in_bounds and finger_y_in_bounds:
